                                ...
                                <table class="table" id="tableDiv">
                                    <thead>
                                        <tr class="bg-dark text-white">
                                            ...
                                            <th style="width: 10%;">Warranty<br>(IN MONTH)</th>
                                            <th class="text-center">Sl.No.From </th>
                                            <th class="text-center">Sl.No.To </th>
                                            <th >&nbsp;</th>
                                        </tr>
                                    </thead>
                                    <tbody id="tbody">
                                        ...
                                        <tr id="row_serial_1">
                                            <td>Sl.No. </td>
                                            <td colspan="5"><input type="text" class="form-control" name="c_sl[]" id="c_sl_1"  value=""  placeholder="(E.x.- 111,222,333)"> </td> 
                                            <td>&nbsp;</td>
                                        </tr>
                                    </tbody>
                                </table>
    ...
    if (x < count) {
        if ($('#mc_type_' + x).val() !== '' && $('#mc_qty_' + x).val() !== '') {
            ...
            <tr id="row_${x}">
                ...
                <td class="text-left dropDownCus">
                    <select class="form-control" name="mc_type[]" id="mc_type_${x}" required>
                        <option value=""> -- Select Device -- </option>
                        <?php foreach($machines as $liquor){
                            echo "<option value='".$liquor->mc_id."'>".$liquor->mc_type."</option>"; 
                        } ?>
                    </select>
                </td>
                <td><input type="number" class="form-control" name="mc_qty[]" id="mc_qty_${x}" placeholder="Quantity"></td>
                <td><input type="number" class="form-control" name="warr_prd[]" id="warr_prd_${x}" placeholder=""></td>
                <td><input type="number" class="form-control" name="sl_frm[]" id="sl_frm_${x}" placeholder=""></td>
                <td><input type="number" class="form-control" name="sl_to[]" id="sl_to_${x}" placeholder=""></td>
                <td>
                    <button type="button" id="remove_${x}" class="btn btn-danger btn-rounded btn-icon" onclick="_delete(${x})">
            ...
            <tr id="row_serial_${x}">
                <td>Sl.No.</td>
                <td colspan="6">
                    <input type="text" class="form-control" name="c_sl[]" id="c_sl_${x}" placeholder="(E.x.- 111,222,333)">
                </td>
            </tr>
            `;
...
function _delete(id) {
    ...
    if (r) {
        $('#row_' + id).remove();
        $('#row_serial_' + id).remove(); // also remove serial row
        x--;
    }
}
</script>
