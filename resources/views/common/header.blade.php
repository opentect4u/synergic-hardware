...
.app-navbar .navbar-menu-wrapper {
...
<nav class="navbar app-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo" href="{{route('dashboard')}}"><img src="{{ asset('public/images/logo.png') }}" alt="logo" /></a>
        <a class="navbar-brand brand-logo-mini" href="{{route('dashboard')}}"><img src="{{ asset('public/images/logo.png') }}"
                alt="logo" /></a>
    </div>
        ...
        <ul class="navbar-nav navbar-nav-right">
            ...
            <li class="nav-item nav-profile dropdown mr-0 mr-sm-2">
                <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" data-toggle="dropdown"
                    id="profileDropdown">
                    <i class="mdi mdi-account-circle mr-2" style="font-size:28px;"></i>
                    <span class="nav-profile-name">{{auth()->user()->user_name}}</span>
                </a>
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
                    ...
                    <div class="dropdown-item">
                        ...
                        <span>Last login: {{ $lastLogin ? date('d-m-Y H:i', strtotime($lastLogin)) : 'Not available' }}</span>
                    </div>
                    ...
                    <a class="dropdown-item" href="{{route('logout')}}">
                        <i class="mdi mdi-logout text-primary mr-2"></i>
                        <span>Logout</span>
                    </a>
                </div>
            </li>
